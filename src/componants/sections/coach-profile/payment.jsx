      ...
      <div className="mb-8 bg-[#F8F8F8] border border-[#E2E2E2] p-6 rounded-lg mdw-[50%]">;
        ...
        <div className=" py-3 border-b border-[#E2E2E2]">
          ...
          <div className="flex gap-10 mt-4">
            <input
              type="text"
              className=" bg-white w-[70%] border border-main rounded-4xl"
            />
            <button className="bg-main text-white w-[30%] p-3 rounded-4xl">
              Active
            </button>
          </div>
        ...
        <div className="space-y-4 mt-4 border-b border-[#E2E2E2]">
          <div
            className={`flex justify-between  font-semibold text-lg text-gray-700`}
          >
            <span className="text-[#828282] text-[16px] font-[400]">
              Discount (promo code)
            </span>
