    ...
    <div className="w-[95%] md:w-[80%] m-auto my-20 flex items-center flex-wrap md:flex-nowrap gap-16">
      <div className="w-[40%] flex flex-col items-center gap-10 md:w-1/4">
        <div className={`relative ${classess.border_line}`}>
          ...
          >
            <img className="w-full h-full object-cover" src={free_1} alt="coach img" />
          </div>
        </div>
      ...
      <div className="w-[30%] flex flex-col items-center gap-10 md:w-1/4">
        ...
        <div className="w-[200px] h-[300px] overflow-hidden rounded-[20px] md:w-[250px] md:h-[350px] ">
          <img className="w-full h-full object-cover" src={free_2} alt="coach img" />
        </div>
      </div>
      {!getSession && (
        <div className="w-full flex flex-col gap-10 md:w-1/2">
          <SectionTitle className="text-main text-[20px] ml-12 md:ml-10 before:bg-main">
            {t('freeSession.title')}
          </SectionTitle>
          <Link
            to="free-session"
            className="bg-main text-white text-[20px] w-fit px-8 py-3 rounded-full md:text-[25px]"
          >
          ...
          <div className="flex flex-col gap-5">
            {questions.map((question, index) => (
              <p
                key={index}
                className="text-[#2A4A45] text-[16px] flex items-center gap-2 md:text-[22px]"
              >
