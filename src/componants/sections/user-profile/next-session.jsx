  ...
  return (
    <div>
            ...
            <div className="pl-5 pb-6 border-b border-[#D3D3D3]">
                ...
                <a className="text-blue-600" href="#">https://www.zoom.com/</a>
            </div>
            <div className="flex items-center justify-between">
                <div>
                    <p className="text-[16px] font-[700] text-[#11141A] mb-4 ">Cancellation policy</p>
                    <p className="w-[80%]">Cancel for free anytime in advance, otherwise you will be charged 
                    100% of the service price for not showing up.</p>
                </div>
                <button className="bg-[#FFF0F0] p-3 flex items-center gap-1 rounded-2xl">
                    <p className="text-red-500 text-lg"><MdCancel /></p>
                    Refund
                </button>
            </div>
        </div>
