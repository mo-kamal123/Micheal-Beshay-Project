    ...
    <div className=" bg-body">
        ...
        <div className="w-[95%] md:w-[70%] m-auto py-20 flex flex-col gap-5 ">
            ...
            <div>
                ...
                <input required className="w-full py-3 px-6 border border-main bg-white rounded-4xl font-light text-[14px] placeholder-[#ACACAC]" type="text" name="name" id="name" placeholder="Enter your name"/>
            </div>
            <div>
                <p className="text-[#666C6F] mb-2">Leave your feedback*</p>
                <textarea required className="w-full py-3 px-6 h-[150px] border border-main bg-white rounded-3xl font-light text-[14px] placeholder-[#ACACAC]" type="text" name="name" id="name" placeholder="leave your message"/>
            </div>
