    ...
    <div className="bg-white p-5 rounded-2xl">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[#101928] text-[14px] ">
          Charge your wallet to have credit and use your credit to book your sessions and more.
        </p>
      </div>
      <div className="flex justify-between my-7">
        <p className="text-[#11141A] text-[16px] font-[700] ">
          Your Wallet credit <span className="font-[400]">340,00 EGP</span>
        </p>
        <Link to="/profile/recharge-wallet" className="bg-main text-white py-2 px-4 rounded-xl ">
          Recharge
        </Link>
      </div>
      <div>
