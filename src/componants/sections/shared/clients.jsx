...
function Clients() {
  ...
  return (
    <div className="flex flex-col gap-10 w-[90%] m-auto my-20 md:w-[80%] md:flex-row">
      <div>
        <SectionTitle className="text-main text-[16px] ml-10 before:bg-[#5A717C] md:text-[20px]">
          {t('trust.title')}
        </SectionTitle>
        <h1 className="text-[24px] font-bold mt-3 md:text-[50px]">{t('trust.heading')}</h1>
      </div>
      ...
      <div className="bg-main text-white w-[95%] m-auto p-8 flex flex-col gap-5 rounded-4xl md:w-[80%]">
        ...
        <p className="text-[15px] leading-6 md:text-[20px]">{testimonial.text}</p>
        <div className="mt-2">
